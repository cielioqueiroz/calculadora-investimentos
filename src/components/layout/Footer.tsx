...
export function Footer() {
  ...
  return (
    <footer className="border-t border-border/15 bg-card/40">
      <div className="mx-auto flex w-full max-w-[1400px] flex-col gap-1 px-4 py-3 text-sm text-muted-foreground md:flex-row md:items-center md:justify-between md:px-8">
        <p>
